...
codes = [{"code":"C10FJ11","system":"readv2"},{"code":"C10FJ00","system":"readv2"},{"code":"C109J00","system":"readv2"},{"code":"C109J12","system":"readv2"},{"code":"O240","system":"readv2"},{"code":"O241","system":"readv2"},{"code":"E10","system":"readv2"},{"code":"E11","system":"readv2"}];
REQUIRED_CODES = 1;
